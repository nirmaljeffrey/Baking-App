...
public class DetailActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    final String ingredientBodyString = String
        .format(getResources().getString(R.string.ingredient_body), recipeName, recipeServings);
    String recipeStepBodyString = String
        .format(getResources().getString(R.string.recipe_step_body), recipeName, recipeName);
    ingredientBodyTextView.setText(ingredientBodyString);
    recipeStepBodyTextView.setText(recipeStepBodyString);
    //OnclickListener for ingredient card to open IngredientActivity
    ingredientCardView.setOnClickListener(view -> {
      ...
      ingredientIntent.putParcelableArrayListExtra(Constants.INGREDIENT_LIST_INTENT_EXTRA_CONSTANT,
          ingredients);
      startActivity(ingredientIntent);
    });
    //OnClickListener for recipeStep card to open RecipeStepMasterActivity
    recipeStepCardView.setOnClickListener(view -> {
      ...
      recipeStepIntent.putParcelableArrayListExtra(Constants.RECIPE_STEP_LIST_INTENT_EXTRA_CONSTANT,
          recipeSteps);
