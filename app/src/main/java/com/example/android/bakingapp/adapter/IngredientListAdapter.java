...
public class IngredientListAdapter extends
    RecyclerView.Adapter<IngredientListAdapter.IngredientItemViewHolder> {
  ...
  @Override
  public void onBindViewHolder(@NonNull IngredientItemViewHolder ingredientItemViewHolder,
      int position) {

    if (ingredientItemViewHolder.view_type == TYPE_HEADER) {
      ingredientItemViewHolder.linearLayout
          .setBackgroundColor(ContextCompat.getColor(context, R.color.colorTableHeader));
  ...
  public static class IngredientItemViewHolder extends RecyclerView.ViewHolder {
    ...
    IngredientItemViewHolder(@NonNull View itemView, int viewType) {
      super(itemView);
